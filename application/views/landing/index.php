        ...
        <div class="container">
            ...
            <div class="feature_row row">
                <div class="col-md-6 feature_img">
                    <img src="<?=base_url('assets/landing/')?>images/feature-man-2.jpg" alt="">
                </div>
                ...
                <div class="portfolio_item portfolio_2">
                   <div class="grid-sizer-2"></div>
                    ...
                    <div class="single_facilities col-sm-5 painting webdesign">
                        <img src="<?=base_url('assets/landing/')?>images/feature-man-4.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="testimonial_carosel">
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="img-circle" src="<?=base_url('assets/landing/')?>images/testimonial-2.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="img-circle" src="<?=base_url('assets/landing/')?>images/testimonial-3.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading">Emran Khan</h4>
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="img-circle" src="<?=base_url('assets/landing/')?>images/testimonial-1.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
